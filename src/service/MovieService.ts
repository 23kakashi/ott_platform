...
class MovieService {
  constructor() {}
  async addMovieToDb({ title, rating, language, release_date, plan, url, actors, directos, geners }: MovieDataType) {
